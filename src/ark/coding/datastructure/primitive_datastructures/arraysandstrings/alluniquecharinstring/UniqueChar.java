package ark.coding.datastructure.primitive_datastructures.arraysandstrings.alluniquecharinstring;
...
public class UniqueChar implements Solution<Boolean>{
    ...
    /*
     * Use BitMAP to track already tracked ints,
     * boolean[] uniqueChar = new boolean[ASCII.size()]
     * if(uniqueChar[string.codePointAt(i)])
     * ========================================================================
    ...
    private boolean doesStringHasUniqueChar(String string){
        ...
        for(int i = 0 ; i < stringLength; i++){
            if(charBitMap[string.codePointAt(i)] == true){
                return NO_UNIQUE_CHAR;
            }
